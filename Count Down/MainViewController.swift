...
class MainViewController: UIViewController {
    ...
    var countdownDate: Date? {
        didSet {
            ...
            updateLabelsTimer = Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(MainViewController.updateTimeRemaining), userInfo: nil, repeats: true)
        }
    }
    ...
    @IBAction func updateTimeRemaining() {
